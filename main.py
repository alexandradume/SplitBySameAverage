...
class Solution(object):
    def splitArraySameAverage(self, A):
        ...
        if not verify:
            return False
        # After that, all the possible combinations of the sum of index numbers from the table are generated
        ...
        # on the index position in sums hashset the value totalSum * index / lengthOfA the method returns
        # true
        for index in range(1, lengthOfB + 1):
